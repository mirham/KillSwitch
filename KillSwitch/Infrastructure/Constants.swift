...
struct Constants{
    ...
    static let settingsElementExtendedIpAddressInfo = "Extended IP Address Information Required"
    ...
    static let settingsKeyuseExtendedIpAddressInfo = "use-picky-mode"
    ...
    static let settingsKeyClosingApps = "apps-to-close"
    ...
    static let hintExtendedIpAddressInfo = "Uses extended IP address information, such as country. An IP address cannot be added to the allowed list if reliable information about it is unavailable."
